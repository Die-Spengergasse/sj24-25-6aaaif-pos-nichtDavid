...
namespace SPG_Fachtheorie.Aufgabe3.Test
{
    public class PaymentsControllerTest
    {
        [Theory]
        [InlineData(1, null, 2)]
        [InlineData(0, "2024-05-23", 2)]
        [InlineData(1, "2024-05-23", 1)]
        ...
        public async Task GetPaymentById_Test(int id, HttpStatusCode expectedStatus)
        {
            var factory = new TestWebApplicationFactory();
            factory.InitializeDatabase(db => {
                var employee1 = new Cashier(1, "FN", "LN", new DateOnly(2004, 3, 2), 3000M, null, "Feinkost");
        ...
        public async Task PatchPaymentById_Test(int id, HttpStatusCode expectedStatus)
        {
            var factory = new TestWebApplicationFactory();
            factory.InitializeDatabase(db => {
                var employee1 = new Cashier(1, "FN", "LN", new DateOnly(2004, 3, 2), 3000M, null, "Feinkost");
